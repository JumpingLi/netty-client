...
import com.iflytek.sas.voice.transfer.server.client.RpcProxyFactoryBean;
...
//                PackageClassUtils.resolver(basePackage);
        Collections.singletonList("com.iflytek.sas.voice.transfer.server.rpc.service.DemoService");
